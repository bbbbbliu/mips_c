...
/*     // Open an in-memory stream that writes dynamically directly to our
 * buffer */
/*     // string */
...
/*     fclose(mem_stream); // Forces the stream to flush calculations directly
 * into */
/*                         // 'buffer' */
...
/*         "0x00000000: 78 56 34 12                                      |
 * xV4.\n" */
/*         "---------------------------------------------------------\n"; */

/*     cr_assert_str_eq(buffer, expected, */
/*                      "The RAM dump output did not match the expected
 * format."); */
